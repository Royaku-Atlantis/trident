...
enum OperatorType : unsigned char {OP_EMPTY, OPn_SUB, OPn_ADD, OPn_MUL, OPn_DIV, OPn_MOD, OPl_GET, OPb_AND, OPb_OR, OPb_NOT, OPb_XOR, OPb_COND, OPc_strictINF, OPc_strictSUP, OPc_equalINF, OPc_equalSUP, OPc_EQUAL, OPc_roundEQUAL, OPc_UNEQUAL};
